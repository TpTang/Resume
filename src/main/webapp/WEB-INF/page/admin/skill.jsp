...
<body class="theme-blue">
                                    ...
                                    <form id="remove-form" method="post" action="${ctx}/skill/remove">
                                        <c:forEach items="${skills}" var="skill">
                                            <tr>
                                                <td>
                                                    <div class="switch">
                                                        <%--提交表单的时候只有被选中的id值会被发送到服务器--%>
                                                        <label><input type="checkbox" name="id" value="${skill.id}"><span class="lever switch-col-blue"></span></label>
                                                    </div>
                                                </td>
                                                <td>${skill.name}</td>
    ...
    <script>
        ...
        addValidatorRules('.form-validation') //表单合法验证
        ...
        function edit(skill) {
            add()
            for (const key in skill){ //key：id name level
