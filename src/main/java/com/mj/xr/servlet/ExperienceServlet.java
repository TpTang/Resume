...
import com.mj.xr.service.*;
import com.mj.xr.service.impl.CompanyServiceImpl;
import com.mj.xr.service.impl.ExperienceServiceImpl;
...
public class ExperienceServlet extends BaseServlet{
    ...
    public void save(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        company.setId(Integer.valueOf(request.getParameter("companyId"))); //dao层save时只用到company.id
        experience.setCompany(company);

        if (service.save(experience)) { //持久化成功
