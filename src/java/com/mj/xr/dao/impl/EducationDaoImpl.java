...
//     */
    ...
    public Education get(Integer id){
        ...
        return DBUtil.getTpl().queryForObject(sql, new BeanPropertyRowMapper<>(Education.class), id);
    }
    /**
     * 获取多个对象
     */
    public List<Education> list(){
        ...
        return DBUtil.getTpl().query(sql, new BeanPropertyRowMapper<>(Education.class));
    }
